...
const controls={
  ...
  azov:[39.4233,47.1121],astrakhan:[48.0336,46.3479],
  kyakhta:[106.4509,50.3574],irkutsk:[104.2964,52.2864],ulan_ude:[107.5846,51.8345]
};
const rows=[];
...
const out={schema_version:2,archive:file,archive_git_blob_sha1:crypto.createHash('sha1').update(Buffer.from(`blob ${bytes.length}\0`)).update(bytes).digest('hex'),rows};
fs.writeFileSync('empire-1727-1737-current.json',JSON.stringify(out,null,2)+'\n');

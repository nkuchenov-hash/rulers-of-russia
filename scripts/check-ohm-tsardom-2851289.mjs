...
const xml=await res.text(); const rel=xml.match(/<relation\s+([^>]+)>/); if(!rel) throw new Error('relation missing');
...
fs.writeFileSync('ohm-tsardom-2851289.json',JSON.stringify(out,null,2)+'\n'); console.log(JSON.stringify(out,null,2));
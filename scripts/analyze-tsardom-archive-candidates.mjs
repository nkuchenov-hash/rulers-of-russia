...
// Broad diagnostic controls. These are research signals only; a passing row is not auto-promoted.
const controls = [
  {id:'moscow', lonLat:[37.6173,55.7558]},
  {id:'novgorod', lonLat:[31.2755,58.5229]},
  {id:'pskov', lonLat:[28.3318,57.8193]},
  {id:'smolensk', lonLat:[32.0453,54.7826]},
  {id:'kazan', lonLat:[49.1064,55.7963]},
  {id:'astrakhan', lonLat:[48.0408,46.3497]},
  {id:'tyumen', lonLat:[65.5343,57.1530]},
  {id:'tobolsk', lonLat:[68.2538,58.1981]},
  {id:'tomsk', lonLat:[84.9482,56.4846]},
  {id:'krasnoyarsk', lonLat:[92.8932,56.0153]},
  {id:'irkutsk', lonLat:[104.2807,52.2864]},
  {id:'yakutsk', lonLat:[129.7326,62.0278]},
  {id:'okhotsk', lonLat:[143.217,59.36]},
  {id:'kyiv', lonLat:[30.5234,50.4501]},
  {id:'warsaw', lonLat:[21.0122,52.2297]},
  {id:'riga', lonLat:[24.1052,56.9496]},
  {id:'azov', lonLat:[39.416,47.112]},
  {id:'bakhchysarai', lonLat:[33.857,44.75]},
